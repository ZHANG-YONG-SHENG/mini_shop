...
(3, '梅林 PVC', '', 5000, 1, '2020-11-10 05:52:35'),
(2, '宮本武藏 景品', '', 450, 1, '2020-11-10 05:51:43'),
(4, '埃什基伽仂 PVC', '', 9999, 1, '2020-11-10 05:53:44'),
(5, '葛氏北齋 PVC', '', 8500, 1, '2020-11-10 05:54:50'),
(7, '術吉爾加美什 景品', '', 500, 3, '2020-11-10 05:57:52');
...
(1, '阿勇勇', 'MLGB', '$2y$10$wWlrcFwSf2YXWTPxvyVSuOYpLMvmwmV8JipR6YLE61vaYaYGnokbe', 'H24663101@mailst.cjcu.edu.tw', '先生', '12345678', '701', '台南市', '東區', '公寓');
...
--
ALTER TABLE `goods`
  MODIFY `goods_sn` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '商品編號', AUTO_INCREMENT=8;
